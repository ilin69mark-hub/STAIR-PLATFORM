...
import type { Nesting, PlacedPart, SheetLayout } from '../../api/types'
  ...
  return (
    <div className="scheme">
      ...
      <p className="scheme__caption">
        Деталей: {nesting.PartCount} · площадь деталей {fmt.mm2(nesting.PartArea)} · отходы{' '}
        {fmt.mm2(nesting.WasteArea)} · использование {fmt.pct(nesting.Utilization)}
      </p>
    </div>
  )
}
