...
describe('fmt.m2 / fmt.m3', () => {
  it('переводит мм² в м²', () => {
    expect(fmt.m2(1_000_000)).toBe('1 м²')
    expect(fmt.m2(4_100_000)).toBe('4,1 м²')
    expect(fmt.m2(18_000_000)).toBe('18 м²')
  })

  it('переводит мм³ в м³', () => {
    expect(fmt.m3(1_000_000_000)).toBe('1 м³')
    expect(fmt.m3(12_000_000)).toBe('0,012 м³')
  })

  it('undefined → длинное тире', () => {
    expect(fmt.m2(undefined)).toBe('—')
    expect(fmt.m3(undefined)).toBe('—')
  })
})
