...
const FAQ = [
  {
    ...
    a: 'Стальной прямой марш 900×2700 мм выходит в десятки тысяч рублей, деревянный — в сотни тысяч, спираль и сложные конфигурации дороже. Точную цифру даёт калькулятор: он считает материал, раскрой, работу и НДС.',
  },
  {
      ...
      <section className="wrap hero">
        <div>
          ...
          <p className="hero__lead">
            Проектируем прямые, L-образные, П-образные и спиральные марши.
