...
export const metadata: Metadata = {
  ...
  description:
    'Проектируем лестницы для квартир и домов: честный расчёт геометрии, 3D-визуализация и предварительная цена по материалам. Прямые, L-образные и П-образные марши.',
  openGraph: {
    type: 'website',
    locale: 'ru_RU',
